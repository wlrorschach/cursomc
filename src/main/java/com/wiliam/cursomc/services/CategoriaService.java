...
public class CategoriaService {
	...
	// anotacao responsavel por atribuir ao spring a responsabilidade de injetar
	// esta dependencia
	@Autowired
	...
	public Categoria find(Integer id) {
		...
		return obj.orElseThrow(
				() -> new ObjectNotFoundException("Objeto não encontrado! id:" + Categoria.class.getName()));
	}

	// metodo reponsável por inserir uma nova Categoria
	public Categoria insert(Categoria obj) {
		/*
		 * http status code : quando eh uma requisicao para insercao, o codigo é 201 ao
		 * inserir uma nova categoria, devo fornecer a nova URI como resposta a
		 * requisicao
		 */
